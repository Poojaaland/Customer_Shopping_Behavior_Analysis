...
select item_purchased, round(avg(review_rating::numeric),2) as avg_rating from customer
group by item_purchased 
order by avg(review_rating) desc
limit 5;

-- Q4. Compare the average prchase amounts between standard and express shipping?
...
select subscription_status, round(avg(purchase_amount::numeric),2) as avg_spend,
...
-- Q7. Segment customer into new, returning, and loyal based on their total number of previous purchase and show
...
group by age_group; -- Adult,Senior,Young Adult, Middle-age
